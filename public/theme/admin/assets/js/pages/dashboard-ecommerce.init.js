...
function getDataOrder(e){
	if(null!==document.getElementById(e)){
		var t=document.getElementById(e).getAttribute("data-orders");
		if(t)
			return t.split("-");
			console.warn("data-order atributes not found on",e)
	}
}

function getDataEarn(e){
	if(null!==document.getElementById(e)){
		var t=document.getElementById(e).getAttribute("data-earns");
		if(t)
			return t.split("-");
			console.warn("data-order atributes not found on",e)
	}
...
function getDataRefund(e){
	if(null!==document.getElementById(e)){
		var t=document.getElementById(e).getAttribute("data-refunds");
		if(t)
			return t.split("-");
			console.warn("data-order atributes not found on",e)
	}
...
function getDataViews(e){
	if(null!==document.getElementById(e)){
		var t=document.getElementById(e).getAttribute("data-views");
		if(t){}
			return t.split("-").map(str => Number(str));
			console.warn("data-order atributes not found on",e)
	}
}
