                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive table-card">
                                <table id="example" class="table table-hover table-centered align-middle table-nowrap mb-0">
                                    <thead>
                                        <tr>
                                            <th>Product</th>
                                            <th>Price</th>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-sm bg-light rounded p-1 me-2">
                                                        <img src="{{ asset('uploads/' . $r->thumbnail) }}" alt="" class="img-fluid d-block" />
                                                    </div>
                                                    <div>
                                                        <h5 class="fs-14 my-1"><a href="apps-ecommerce-product-details.html" class="text-reset">{{ $r->name_product }} ({{ $r->color }} {{ $r->size }})</a></h5>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>{{ $r->price }}</td>
                                ...
                                <div class="table-responsive table-card">
                                    <table id="example1" class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="apps-ecommerce-order-details.html" class="fw-medium link-primary">#{{ $to->id }}</a>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                ...
                                                <td>
                                                    <span class="text-success">{{ $to->total_amount }}</span>
                                                </td>
                                                <td>
                                                    <span class="badge bg-success-subtle text-success">{{ $to->status_name }}</span>
                                                </td>
                                                <td>
                                                    <span class="badge bg-success-subtle text-success">{{ $to->payment_name }}</span>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                            ...
                            <div class="row g-0 text-center">
                                <div class="col-6 col-sm-4">
                                    <div class="p-3 border border-dashed border-start-0">
                                        <h5 class="mb-1"><span class="counter-value" data-target={{ $data->amount }}>0</span></h5>
                                ...
                                <div class="col-6 col-sm-4">
                                    <div class="p-3 border border-dashed border-start-0">
                                        <h5 class="mb-1"><span class="counter-value" data-target={{ $data->refund }}></span></h5>
